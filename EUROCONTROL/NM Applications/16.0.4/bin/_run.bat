...
if EXIST ..\etc\preferences\lookfeelwindows10.txt  SET CHMICLIENT_OPTIONS=%CHMICLIENT_OPTIONS% -Dchmi.simulaccessurl="%CHMI_SIMUL_ACCESSURL%" -Dchmi.winLookAndFeelFix=true
