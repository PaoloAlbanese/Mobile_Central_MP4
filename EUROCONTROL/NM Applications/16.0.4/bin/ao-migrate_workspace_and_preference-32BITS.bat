...
SET PREFERENCE_SRC="c:\Program Files\Eurocontrol\NM Applications\15.5.4\etc\preferences\chmi.preferences"
 SET WORKSPACE_SRC="c:\Program Files\Eurocontrol\NM Applications\15.5.4\etc\preferences\chmi.workspaces"
