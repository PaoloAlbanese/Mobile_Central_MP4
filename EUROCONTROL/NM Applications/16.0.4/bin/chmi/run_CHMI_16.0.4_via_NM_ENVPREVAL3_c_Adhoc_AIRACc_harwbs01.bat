rem run_CHMI_16.0.4_via_NM_ENVPREVAL3_c_Adhoc_AIRACc_harwbs01.bat
...
@echo ************************************************************************
@Echo *     ATTENTION                                                        *
@Echo *     You have selected the ENVPREVAL (not Operational)  shortcut,     *
@Echo *     You should only use this shortcut to PRE-VALIDATE AIRAC DATA     *
