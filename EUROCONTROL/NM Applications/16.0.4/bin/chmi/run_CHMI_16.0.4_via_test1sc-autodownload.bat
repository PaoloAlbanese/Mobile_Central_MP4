rem run_CHMI_16.0.4_via_test1sc-autodownload.bat
...
SET CHMI_WEBSERVER=www.test1.nm.eurocontrol.int
...
@echo ************************************************************************
@Echo *     ATTENTION                                                        *
@Echo *     You have selected the OPSTEST SATI     shortcut,                 *
@Echo *     You should only use this shortcut if you have an OPSTEST Account *
