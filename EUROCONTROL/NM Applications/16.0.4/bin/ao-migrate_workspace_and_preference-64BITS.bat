...
rem For AO   for NM customers update the statement SET PREFERENCE_SRC and SET WORKSPACE_SRC with your own location of 15.5.4
rem For AO   for NM customers update the statement SET PREFERENCE_SRC and SET WORKSPACE_SRC with your own location of 15.5.4
rem For AO   for NM customers update the statement SET PREFERENCE_SRC and SET WORKSPACE_SRC with your own location of 15.5.4
...
rem ANSP
rem      %CHMI_DEST%\jre\bin\java -classpath %CHMI_DEST%\patch\CHMI.ATFCM.controllers.jar;%CHMI_DEST%\patch\CHMI.FRAMEWORK.common.jar;%CHMI_DEST%\patch\CHMI.FRAMEWORK.controllers.jar;%CHMI_DEST%\patch\CHMI.COMMON.controllers.jar;%CHMI_DEST%\patch\CHMI.CHMI_CONFIG.chmi.jar;%CHMI_DEST%\jar\CHMI.ATFCM.controllers.jar;%CHMI_DEST%\jar\CHMI.FRAMEWORK.common.jar;%CHMI_DEST%\jar\CHMI.FRAMEWORK.controllers.jar;%CHMI_DEST%\jar\CHMI.COMMON.controllers.jar;%CHMI_DEST%\jar\CHMI.CHMI_CONFIG.chmi.jar;
rem %CHMI_DEST%\jar\CUA.CORE.iem.cua.jar;%CHMI_DEST%\jar\CUA.CORE.em-framework.jar;%CHMI_DEST%\jar\CUA.COMMON.shared.jar eurocontrol.cfmu.chmi.WorkspaceAndPreferenceConverter %PREFERENCE_SRC% %PREFERENCE_DEST% %WORKSPACE_SRC% %WORKSPACE_DEST% %5 %6 %7 2> convert_Prefs.log 

    ..\jre\bin\java -classpath ..\patch\CHMI.ATFCM.controllers.jar;..\patch\CHMI.FRAMEWORK.common.jar;..\patch\CHMI.FRAMEWORK.controllers.jar;..\patch\CHMI.COMMON.controllers.jar;..\patch\CHMI.CHMI_CONFIG.chmi.jar;..\jar\CHMI.ATFCM.controllers.jar;..\jar\CHMI.FRAMEWORK.common.jar;..\jar\CHMI.FRAMEWORK.controllers.jar;..\jar\CHMI.COMMON.controllers.jar;..\jar\CHMI.CHMI_CONFIG.chmi.jar;..\jar\CUA.CORE.iem.cua.jar;..\jar\CUA.CORE.em-framework.jar;..\jar\CUA.COMMON.shared.jar       eurocontrol.cfmu.chmi.WorkspaceAndPreferenceConverter %PREFERENCE_SRC% %PREFERENCE_DEST% %WORKSPACE_SRC% %WORKSPACE_DEST% %5 %6 %7 2> fixPrefs.log
